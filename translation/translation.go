...
var en = map[string]string{
	...
	"unit_types":    "{'Army': 'Army', 'Fleet': 'Fleet'}",
	"After":         "After",
	...
	"Planner":       "Planner",
	"Results":       "Results",
	"order_types":   "{'Move': 'Move', 'Support': 'Support', 'Hold': 'Hold', 'Convoy': 'Convoy', 'MoveViaConvoy': 'Move via Convoy', 'Build': 'Build', 'Disband': 'Disband'}",
}
